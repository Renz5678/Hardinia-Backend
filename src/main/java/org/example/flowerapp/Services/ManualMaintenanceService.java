...
public class ManualMaintenanceService {
    ...
    public Maintenance createManualTask(long flowerId, MaintenanceType type,
    ...
    public void toggleAutoScheduling(long flowerId, boolean enabled) {
        Flower flower = flowerRepository.findByFlowerId(flowerId);
    ...
    public void rescheduleTask(long taskId, LocalDateTime newDate) {
        Maintenance task = maintenanceRepository.findByTaskId(taskId);
    ...
    public void deleteTask(long taskId) {
        maintenanceRepository.deleteMaintenance(taskId);
    }
}